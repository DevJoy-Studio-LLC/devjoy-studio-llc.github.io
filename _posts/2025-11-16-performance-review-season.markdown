---
layout: post
title:  "It's Performance Review Season!"
date:   2025-11-16
...
_Spoiler alert: I'm both looking for work and trying to build an app that people will be able to use to write their work logs._
...
When I'm reading back that entry, I immediately remember that I spent a lot of time that day tweaking the Figma design for my Journaling app to make it more responsible to size changes. I can also go read previous entries and see that I had just started learning [Figma](https://https://www.figma.com) a few days prior to that.
